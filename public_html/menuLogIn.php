   ...
   <body>
      ...
      <div class="container text-center">
         ...
         <div class="row" id="ads">
            ...
            <div class="col-md-4">
               <div class="card rounded">
                  ...
                  <div class="card-body text-center">
                     <button type="button" class="btn btn-warning"><?=$BtnAcheter[$_SESSION['language']]?></button>
                  </div>
                  <div class="card-body text-center">
                     <a href="modifier.php?id=<?=$id[$i]?>" id=<?=$i?> class="btn btn-primary"> Modification</a>
                     <a class="btn btn-danger" id="refuse" href="scripts/delete.php?id=<?=$id[$i]?>"> <?=$BtnSupprimer[$_SESSION['language']]?></a>
                  </div>
               </div>
            </div>
            <?php
            ...
            <a href="creationProduit.php" class="btn btn-primary"><?=$BtnCreation[$_SESSION['language']]?></a>
            <div class="container">
               </br>
               <ul class="pagination justify-content-center">
                  <?php 
                     ...
                     if($_GET["page"] > 1) echo "<li class=\"page-item\"><a class=\"page-link\" href='./menuLogIn.php?page=$previous'><<</a></li>";
                     
                     for($i = 1; $i <= ceil(count($nom)/$nbProduit); $i++){   
                       $active = "";
                       if(($_GET["page"] == $i)) $active = "active";
                       echo "<li class=\"page-item $active\"><a class=\"page-link\" href='./menuLogIn.php?page=$i'>$i</a></li>";
                     } 
                     
                     if($_GET["page"] == ceil(count($nom)/$nbProduit) -1 ) echo "<li class=\"page-item\"><a class=\"page-link\" href='./menuLogIn.php?page=$next'>>></a></li>";
                     ?>
               </ul>
               </br>
            </div>
