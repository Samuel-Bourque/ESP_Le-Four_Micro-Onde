   ...
   if(isset($_SESSION['courriel'])){
     ...
     try {
       $pdo = new PDO($dsn, $connectionId, $connectionPasswd, $options);
        ...
        $result = $stmt->execute([$_SESSION['courriel']]);
...
<html>
   ...
   <body>
      ...
      <div class="container text-center">
         <h1>Menu</h1>
         <div class="ml-auto">
            <h2><?=$Argent[$_SESSION['language']]?> : </h2>
            <h1><?=$prixDepart[0]?>$</h1>
         </div>
         <br>
            ...
            <div class="col-md-4">
               <div class="card rounded">
                  ...
                  <div class="card-body text-center">
                     <a href="scripts/transaction.php?id=<?=$id[$i]?>" class="btn btn-warning"><?=$BtnAcheter[$_SESSION['language']]?></a>
                  </div>
               </div>
            </div>
            <?php
            ...
            <div class="container">
               ...
               <ul class="pagination justify-content-center">
                  <?php 
                     ...
                     if($_GET["page"] > 1) echo "<li class=\"page-item\"><a class=\"page-link\" href='./achatProduit.php?page=$previous'><<</a></li>";
                     
                     for($i = 1; $i <= ceil(count($nom)/$nbProduit); $i++){   
                       $active = "";
                       if(($_GET["page"] == $i)) $active = "active";
                       echo "<li class=\"page-item $active\"><a class=\"page-link\" href='./achatProduit.php?page=$i'>$i</a></li>";
                     } 
                     
                     if($_GET["page"] == ceil(count($nom)/$nbProduit) -1 ) echo "<li class=\"page-item\"><a class=\"page-link\" href='./achatProduit.php?page=$next'>>></a></li>";
                     ?>
               </ul>
               </br>
            </div>
